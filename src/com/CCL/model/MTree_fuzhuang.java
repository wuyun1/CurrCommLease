...
public class MTree_fuzhuang extends JTree {
	...
	public MTree_fuzhuang() {
		super();
		DefaultMutableTreeNode rootNode = new DefaultMutableTreeNode("服装");
		DefaultMutableTreeNode childNode1 = new DefaultMutableTreeNode("1管理");
		DefaultMutableTreeNode childNode2 = new DefaultMutableTreeNode("2管理");
