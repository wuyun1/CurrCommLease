...
public class MTree extends JTree {
	...
	public MTree() {
		super();
		DefaultMutableTreeNode rootNode = new DefaultMutableTreeNode("自行车");
		DefaultMutableTreeNode childNode1 = new DefaultMutableTreeNode("前台收银管理");
		DefaultMutableTreeNode childNode2 = new DefaultMutableTreeNode("会员卡管理");
		DefaultMutableTreeNode childNode3 = new DefaultMutableTreeNode("系统管理");
		DefaultMutableTreeNode childNode4 = new DefaultMutableTreeNode("系统维护");
		DefaultMutableTreeNode childNode5 = new DefaultMutableTreeNode("帮助");
