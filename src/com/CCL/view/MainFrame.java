...
public class MainFrame extends JFrame {
	...
	public MainFrame() throws MalformedURLException {
		...
		// ImageIcon("image/ImageDialog.png").getImage());//设置窗体左上角图标
		initCom();
		initAction();
	...
	private void initCom() throws MalformedURLException {
		...
		MJLable ImageR = new MJLable("images/jpanel/右上1.gif", 383, 90);
		...
		String info = "<html><body><font color=#FFFFFF>你 好：</font><font color=yellow><b>" + "admin" + "</b></font>"
	...
	private SmallScrollPanel getModuleButtonGroup() {
		if (this.moduleButtonGroup == null) {
			...
			this.moduleButtonGroup.setBounds(290, 10, 334, 68);// 设置移动面板位置
			...
			public void valueChanged(TreeSelectionEvent e) {
				if (!MainFrame.this.zixingchetree.isSelectionEmpty()) {
					...
					if (userObject.equals("自行车")) {
						...
						MainFrame.this.fristLabel.setText(userObject);
						sellPanel.removeAll();
						sellPanel.add(new ProgressPanel());// 这里加功能窗口（替换new
															// ProgressPanel()）
					} else if (userObject.equals("会员卡管理")) {
						MainFrame.this.fristLabel.setText(userObject);
						sellPanel.setLayout(null);
						sellPanel.removeAll();
						MemberManagePanel memberManagePanel = new MemberManagePanel();// 这里加功能窗口（替换new
																						// ProgressPanel()）
	...
	private GlassButton getQiCheBtn() {
		if (this.qichebtn == null) {
			...
			this.qichebtn.setIcon(new ImageIcon("images/MJBtn/车.png"));
			ImageIcon icon = new ImageIcon("images/MJBtn/车.png");
	...
	private GlassButton getFangZiBtn() {
		if (this.fangzibtn == null) {
			...
			this.fangzibtn.setIcon(new ImageIcon("images/MJBtn/房子.png"));
			ImageIcon icon = new ImageIcon("images/MJBtn/房子.png");
	...
	private GlassButton getFuZhuangBtn() {
		if (this.fuzhuangbtn == null) {
			...
			ImageIcon icon = new ImageIcon("images/MJBtn/服装.png");
			this.fuzhuangbtn.setSelectedIcon(icon);
			this.fuzhuangbtn.setRolloverIcon(icon);
			this.fuzhuangbtn.setIcon(new ImageIcon("images/MJBtn/服装.png"));
	...
	private GlassButton getBookspaceButton() {
		if (this.bookspaceButton == null) {
			...
			ImageIcon imageIcon = new ImageIcon("images/MJBtn/书籍.png");
			this.bookspaceButton.setIcon(imageIcon);
			ImageIcon icon = new ImageIcon("images/MJBtn/书籍.png");
	...
	private GlassButton getDianZiSheBeiBtn() {
		if (this.dianzishebeibtn == null) {
			...
			ImageIcon imageIcon = new ImageIcon("images/MJBtn/电子设备.png");
			this.dianzishebeibtn.setIcon(imageIcon);
			ImageIcon icon = new ImageIcon("images/MJBtn/电子设备.png");
	...
	private GlassButton getJianZuGongJuBtn() {
		if (this.jianzugongjubtn == null) {
			...
			ImageIcon imageIcon = new ImageIcon("images/MJBtn/建筑工具.png");
			this.jianzugongjubtn.setIcon(imageIcon);
			ImageIcon icon = new ImageIcon("images/MJBtn/建筑工具.png");
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == MainFrame.this.zixingchebtn) {
				if (!backPanel.getName().equals("自行车")) {
					...
					MainFrame.this.fristLabel.setBounds(133, 38, 123, 15);
					MainFrame.this.backPanel.add(MainFrame.this.fristLabel);
					MainFrame.this.paneA2b.add(getZixingCheContentPanel("自行车"));// 重新加入要显示的面板y
					MainFrame.this.fristLabel.setText(backpaneltitle);
					MainFrame.this.repaint();
				}
			}
